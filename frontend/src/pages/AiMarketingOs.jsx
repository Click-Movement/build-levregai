    ...
    <div className="ai-marketing-os">
      ...
      <div className="page">
        ...
        <p className="subheadline">
          Introducing the AI Marketing OS. A done-with-you system that writes your newsletter, creates your ads, builds your funnels, and grows your leads — without you staring at a blank page ever again.
        </p>

        <hr className="divider" />

        <p>Here's a question worth sitting with for a second.</p>

        <p>
          How many hours did you spend last month writing content that didn't convert? Staring at a blank email. Trying to remember how to write a decent subject line. Posting to social and hearing crickets.
        </p>

        <p>Now multiply that by 12.</p>
        ...
        <div className="callout">
          <p>
            The problem isn't your strategy. It's that you don't have a system. And without a system, marketing is just guesswork with a deadline.
          </p>
        </div>

        <p>That's exactly what we built the AI Marketing OS to fix.</p>

        <div className="divider-ornament"><span>not another tool</span></div>

        <h2>An actual operating system for your marketing.</h2>

        <p>Most AI tools give you a blank prompt and tell you to figure it out.</p>
        ...
        <p>
          Not a generic template. Not "fill in the blanks." An actual customized system that knows your product, speaks in your voice, and runs the work for you.
        </p>

        <p>Here's everything you get when you join today:</p>

        <hr className="divider" />

        <h2>What's inside the AI Marketing OS</h2>
        ...
        <div className="items-list">
          ...
          <div className="item">
            ...
            <div className="item-body">
              <p className="item-title">Weekly coaching calls and open office hours</p>
              <p className="item-desc">
                Got a question about a campaign? Stuck on a piece of copy? Bring it to the weekly call or office hours. Direct access, real answers, no ticket queue.
              </p>
            </div>
          </div>
          ...
          <div className="item">
            ...
            <div className="item-body">
              <p className="item-title">The Newsletter Lab community</p>
              <p className="item-desc">
                You're joining a group of newsletter owners and business operators actually building this. Share wins, ask questions, and stay accountable with people in the exact same process as you.
              </p>
            </div>
          </div>
        ...
        <div className="divider-ornament"><span>the honest math</span></div>

        <h2>Let's talk about what this is actually worth.</h2>

        <p>
          A junior content writer costs $3,000–$5,000 a month. And they still need direction, editing, and oversight.
        </p>

        <p>
          A marketing consultant to build your funnel? $5,000–$15,000 upfront. A Facebook ads specialist? Another $2,000–$4,000 a month.
        </p>

        <p>
          And none of them know your voice or your business on day one. You spend weeks onboarding them before you see a single result.
        </p>

        <div className="math-block">
          <div className="math-row">
            <span className="label-col">Content writer (monthly)</span>
            <span className="price-col">$3,000–$5,000/mo</span>
          </div>
          <div className="math-row">
            <span className="label-col">Funnel consultant (upfront)</span>
            <span className="price-col">$5,000–$15,000</span>
          </div>
          <div className="math-row">
            <span className="label-col">Facebook ads specialist</span>
            <span className="price-col">$2,000–$4,000/mo</span>
          </div>
          <div className="math-row">
            <span className="label-col">90 days of 1-on-1 coaching</span>
        ...
        <div className="callout">
          <p>
            The system doesn't take sick days. It doesn't need management. It doesn't charge you more when your revenue goes up. You set it up once and it works for as long as you use it.
          </p>
        </div>
        ...
        <div className="guarantee">
          <div className="g-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="#8b5e3c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="g-text">
            ...
            <p>
              If you show up to the coaching, put in the work, and the system doesn't deliver — we'll make it right. We're not interested in customers who aren't winning.
            </p>
          </div>
        </div>

        <div className="divider-ornament"><span>who this is for</span></div>
        ...
        <p>
          Meaning to get started. Meaning to be consistent. Wondering why you can't seem to make content work.
        </p>
